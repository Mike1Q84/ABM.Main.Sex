...
"" ""
PENS
"virus/1" 1.0 0 -16777216 true "" "ifelse switch-virus \n[plot count virus / 1]\n[plot 0]"
"hosts/1" 1.0 0 -2674135 true "" "plot count hosts / 1"
"supply * 60" 1.0 0 -10899396 true "" "plot mean [supply] of patches * 50"
...
"" ""
PENS
"sexual" 1.0 0 -2674135 true "" "plot count hosts with [sexual? = true]"
"asexual" 1.0 0 -13345367 true "" "plot count hosts with [sexual? = false]"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot mean [sexual-prob] of hosts"
...
"" ""
PENS
"default" 1.0 0 -2674135 true "" "ifelse (count-sex + count-asex != 0)\n[plot (count-sex) / (count-sex + count-asex) * 100]\n[plot 1.11]\n; plot (count hosts with [sexual? = true]) / (count hosts) * 100"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot mean [age] of hosts"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "ifelse switch-virus\n[ifelse (count virus != 0)\n  [plot mean [age] of virus]\n  [plot 0]\n]\n[plot 0]"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot mean [energy] of hosts"
...
<experiments>
  <experiment name="experiment" repetitions="1" runMetricsEveryStep="false">
    ...
    <metric>(count hosts with [sexual? = true]) / (count hosts) * 100</metric>
    <steppedValueSet variable="rapidity" first="0" step="5" last="100"/>
    <steppedValueSet variable="radius" first="1" step="1" last="5"/>
    <enumeratedValueSet variable="switch-virus">
      <value value="true"/>
      <value value="false"/>
    </enumeratedValueSet>
    <steppedValueSet variable="host-move-speed" first="0" step="0.5" last="1.5"/>
    <steppedValueSet variable="relationship-threshold" first="0" step="0.5" last="1"/>
    <steppedValueSet variable="host-birth-energy" first="5" step="5" last="15"/>
    <steppedValueSet variable="replenishment-rate" first="0" step="20" last="100"/>
    <steppedValueSet variable="mutation-rate" first="0" step="0.5" last="5"/>
    <enumeratedValueSet variable="energy-from-host">
      <value value="15"/>
    </enumeratedValueSet>
    <steppedValueSet variable="viru-birth-energy" first="5" step="5" last="15"/>
    <steppedValueSet variable="lifespan" first="5" step="5" last="15"/>
    <steppedValueSet variable="viru-lifespan" first="5" step="5" last="15"/>
  </experiment>
  <experiment name="001" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="300"/>
    <metric>(count hosts with [sexual? = true]) / (count hosts) * 100</metric>
    <steppedValueSet variable="radius" first="1" step="0.5" last="3"/>
    <steppedValueSet variable="relationship-threshold" first="0" step="0.5" last="1"/>
    <enumeratedValueSet variable="switch-virus">
      <value value="true"/>
      <value value="false"/>
    </enumeratedValueSet>
    <steppedValueSet variable="rapidity" first="0" step="5" last="15"/>
    <steppedValueSet variable="mutation-rate" first="0" step="0.5" last="5"/>
  </experiment>
  <experiment name="001.1058.1059" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="300"/>
    <metric>(count hosts with [sexual? = true]) / (count hosts) * 100</metric>
    ...
    <enumeratedValueSet variable="relationship-threshold">
      <value value="0"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="switch-virus">
      <value value="true"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="rapidity">
      <value value="0"/>
    </enumeratedValueSet>
  ...
  <experiment name="001.266" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="300"/>
    <metric>(count hosts with [sexual? = true]) / (count hosts) * 100</metric>
  ...
  <experiment name="001.618" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="300"/>
    <metric>(count hosts with [sexual? = true]) / (count hosts) * 100</metric>
  ...
  <experiment name="001.882" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="300"/>
    <metric>(count hosts with [sexual? = true]) / (count hosts) * 100</metric>
  ...
  <experiment name="020.test" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="300"/>
    <metric>(count hosts with [sexual? = true]) / (count hosts) * 100</metric>
  ...
  <experiment name="021.001" repetitions="1" runMetricsEveryStep="true">
    ...
    <metric>(count-sex) / (count-sex + count-asex) * 100</metric>
    <steppedValueSet variable="radius" first="1" step="1" last="5"/>
    <steppedValueSet variable="relationship-threshold" first="0" step="0.2" last="1"/>
    <enumeratedValueSet variable="switch-virus">
      <value value="true"/>
      <value value="false"/>
    </enumeratedValueSet>
